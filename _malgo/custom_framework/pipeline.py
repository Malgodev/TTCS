...
# TODO Tham khảo thêm trong mmaction2\mmaction\datasets\transforms\loading.py

# Class khởi tạo video, chứa tổng frame và video
...
class VideoSample(BaseTransform):
    """
    Class VideoSample laasy mẫu từ video nhằm tạo các đoạn video con. 
    Args:
        clip_len: soos frame cho mỗi đoạn video
        num_clips: số đoạn video con
    ...
    def transform(self, results):
        """
        Tạo các video con bằng cách lấy các frame ngẫu nhiên
        """
...
# lấy các index frame từ class video sample
@TRANSFORMS.register_module()
...
# đóng gói từ các dữ liệu trên -> đưa vào mô hình
@TRANSFORMS.register_module()
